				...
				<div className="">
					...
					<div className="container column">
						...
						<div className="form-row">
							...
							<input
								name="posX"
								value={gridPosition.posX}
								type="number"
								onChange={gridPositionHandler}
							/>
						</div>
